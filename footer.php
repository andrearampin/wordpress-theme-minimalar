...
<footer id="site-footer" class="site-footer" role="contentinfo">
    ...
    <div class="design-credit">
        <span>
            <?php
            $footer_text = sprintf( __( '<a href="%s">Minimilar</a> theme based on <a href="%s">Cele Theme</a>.', 'cele' ), 'https://github.com/andrearampin/wordpress-theme-minimalar', 'https://www.competethemes.com/cele/' );
